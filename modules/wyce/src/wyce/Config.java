...
public class Config {
  ...
  // TEST FILES
	...
	public static final String FILE2  = "hellocount"; // DONE
	public static final String FILE3  = "fourBasicMathOps"; // DONE
	public static final String FILE4  = "comparatorOps"; // DONE
	public static final String FILE5  = "mathBrackets"; // DONE
	public static final String FILE6  = "charOps"; // DONE
	public static final String FILE7  = "stringOps"; // DONE
	public static final String FILE8  = "boolOps"; // DONE
	// examples from Whiley Language Spec
	public static final String FILE9 = "3_constantDeclarations"; // DONE
...
//	public static final String FILE13 = "./whiley/3_methodDeclaration_withPointer.wyil";
	public static final String FILE14 = "4_typeUnions"; // DONE
//	public static final String FILE15 = "./whiley/4_nullAndTree.wyil"; //// ignore recursive data structures. perhaps later. => David 30/4
	public static final String FILE16 = "4_boolTypeAndUsesArray"; // DONE
	public static final String FILE17 = "4_byteTypeAndForiInLoop"; // done loop stuff, rewrite test case to move the byte operations 30/4
...
//	public static final String FILE20 = "./whiley/4_anyType.wyil"; // exclude 6/5
	public static final String FILE21 = "4_tuples"; // DONE, was a pointer nightmare...
...
//	public static final String FILE51 = "./whiley/recursiveTypes.wyil"; //// ignore => David 29/4
	public static final String FILE52 = "whileMinimal";
	public static final String FILE53 = "main_leds";
	public static final String FILE54 = "main_motors";
	public static final String FILE55 = "arrays";
	public static final String FILE56 = "void_returnType";
